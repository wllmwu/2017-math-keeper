...
#import "MTMathList.h"
#import "MTMathAtomFactory.h" // ADDED
...
- (void)setSubScript:(MTMathList *)subScript
{
    ...
    // BEGIN EDITS
    if (self.type == kMTMathAtomVariable && self.superScript) {
        // insert space before superscript
        MTMathList *mathList = _superScript;
        MTMathAtom *space = [MTMathAtomFactory atomForLatexSymbolName:@"?"];
        _superScript = [MTMathList mathListWithAtoms:space, nil];
        [_superScript append:mathList];
    }
    // END EDITS
...
- (void)setSuperScript:(MTMathList *)superScript
{
    ...
    // BEGIN EDITS
    if (self.type == kMTMathAtomVariable && self.subScript) {
        // insert space before superscript
        MTMathAtom *space = [MTMathAtomFactory atomForLatexSymbolName:@"?"];
        _superScript = [MTMathList mathListWithAtoms:space, nil];
        [_superScript append:superScript];
    }
    else {
