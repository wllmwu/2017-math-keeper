...
//
//  THIS FILE HAS BEEN EDITED BY WILLIAM WU
//
...
@property (nonatomic) UIPanGestureRecognizer *panGestureRecognizer; // ADDED
...
- (void)pan:(UIPanGestureRecognizer *)pan {
    if (self.isFirstResponder) {
        _insertionIndex = [self closestIndexToPoint:[pan locationInView:self]];
        if (_insertionIndex == nil) {
            _insertionIndex = [MTMathListIndex level0Index:self.mathList.atoms.count];
        }
        [_caretView showHandle:NO];
...
- (void) enableTap:(BOOL) enabled
{
    ...
    self.panGestureRecognizer.enabled = enabled; // ADDED
}
...
- (MTMathAtom*) atomForCharacter:(unichar) ch
{
    ...
    // BEGIN EDITS
    else if ([chStr isEqualToString:@"\u2212"]) { // minus sign
        return [MTMathAtomFactory atomForCharacter:'-'];
    }
    else if ([chStr isEqualToString:@"\u22c5"] || [chStr isEqualToString:@"\u00b1"] || [chStr isEqualToString:@"\u2213"] || [chStr isEqualToString:@"\u2218"]) { // cdot, pm, mp, circ
        return [MTMathAtom atomWithType:kMTMathAtomBinaryOperator value:chStr];
    }
    else if ([chStr isEqualToString:@"\u2211"] || [chStr isEqualToString:@"\u222b"] || [chStr isEqualToString:@"\u222e"] || [chStr isEqualToString:@"\u220f"] || [chStr isEqualToString:@"\u2210"]) { // sum, int, oint, prod, coprod
        return [MTMathAtom atomWithType:kMTMathAtomLargeOperator value:chStr];
    }
    else if ([chStr isEqualToString:@"\u2216"] || [chStr isEqualToString:@"\u2229"] || [chStr isEqualToString:@"\u222a"] || [chStr isEqualToString:@"\u00ac"] || [chStr isEqualToString:@"\u2227"] || [chStr isEqualToString:@"\u2228"]) { // setminus, cap (intersection), cup (union), wedge (and), vee (or)
        return [MTMathAtom atomWithType:kMTMathAtomBinaryOperator value:chStr];
    }
    else if ([chStr isEqualToString:@"\u2260"] || [chStr isEqualToString:@"\u223c"] || [chStr isEqualToString:@"\u2248"] || [chStr isEqualToString:@"\u2245"] || [chStr isEqualToString:@"\u2261"] || [chStr isEqualToString:@"\u2225"] || [chStr isEqualToString:@"\u27c2"] || [chStr isEqualToString:@"\u226a"] || [chStr isEqualToString:@"\u226b"] || [chStr isEqualToString:@"\u227a"] || [chStr isEqualToString:@"\u227b"] || [chStr isEqualToString:@"\u2208"] || [chStr isEqualToString:@"\u2209"] || [chStr isEqualToString:@"\u220b"] || [chStr isEqualToString:@"\u2282"] || [chStr isEqualToString:@"\u2283"] || [chStr isEqualToString:@"\u2286"] || [chStr isEqualToString:@"\u2287"] || [chStr isEqualToString:@"\u22a7"]) { // neq, sim, approx, cong, equiv, parallel, perp, ll, gg, prec, succ, in, notin, ni, subset, supset, subseteq, supseteq, models
        return [MTMathAtom atomWithType:kMTMathAtomRelation value:chStr];
    }
    else if ([chStr isEqualToString:@"\u2236"]) { // : ratio
        return [MTMathAtomFactory atomForCharacter:':'];
    }
    else if ([chStr isEqualToString:@"\u27e8"] || [chStr isEqualToString:@"\u2308"] || [chStr isEqualToString:@"\u230a"]) { // langle, lceil, lfloor
        return [MTMathAtom atomWithType:kMTMathAtomOpen value:chStr];
    }
    else if ([chStr isEqualToString:@"\u27e9"] || [chStr isEqualToString:@"\u2309"] || [chStr isEqualToString:@"\u230b"]) { // rangle, rceil, rfloor
        return [MTMathAtom atomWithType:kMTMathAtomClose value:chStr];
    }
    else if ([chStr isEqualToString:@"\u22ef"] || [chStr isEqualToString:@"\u2032"] || [chStr isEqualToString:@"\u2205"] || [chStr isEqualToString:@"\u2200"] || [chStr isEqualToString:@"\u2203"] || [chStr isEqualToString:@"\u2234"] || [chStr isEqualToString:@"\u2235"]) { // cdots, prime, emptyset, forall, exists, therefore, because
        return [MTMathAtom atomWithType:kMTMathAtomOrdinary value:chStr];
    }
    else if ([chStr isEqualToString:@"\u2190"] || [chStr isEqualToString:@"\u2194"] || [chStr isEqualToString:@"\u2192"] || [chStr isEqualToString:@"\u21d0"] || [chStr isEqualToString:@"\u21d4"] || [chStr isEqualToString:@"\u21d2"] || [chStr isEqualToString:@"\u21a6"] || [chStr isEqualToString:@"\u219d"]) { // leftarrow, leftrightarrow, rightarrow, Leftarrow, Leftrightarrow, Rightarrow, mapsto, leadsto
        return [MTMathAtom atomWithType:kMTMathAtomRelation value:chStr];
    }
    // END EDITS
...
- (void) insertText:(NSString*) str
{
    ...
    [str enumerateSubstringsInRange:NSMakeRange(0, [str length]) options:NSStringEnumerationByComposedCharacterSequences usingBlock:^(NSString *substr, NSRange subRange, NSRange enclosingRange, BOOL *stop){
        count++;
    }];
    // END EDITS
